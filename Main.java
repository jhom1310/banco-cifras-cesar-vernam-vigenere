...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String msgcrip = CifradeVigenere.Codificar(key, msg);
        System.out.println("Mensagem codificada: "+ msgcrip);
        System.out.println("Mensagem decodificada: "+ CifradeVigenere.Decodificar(key, msgcrip));
        /*
        int chave = 102;
